...
#define __WI_CLANG_DISABLE_WARNING(warning) // _Pragma("clang diagnostic ignored" #warning)
#else
...
#define __WI_LIBCPP_EXPLICIT explicit
#define __WI_LIBCPP_NORETURN [[noreturn]]
#define __WI_LIBCPP_SUPPRESS_NONINIT_ANALYSIS _Pragma("warning(suppress : 26495)")
#define __WI_LIBCPP_SUPPRESS_NOEXCEPT_ANALYSIS _Pragma("warning(suppress : 26439)")
