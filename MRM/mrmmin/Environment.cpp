    ...
    _Inout_ RemapInfo* pPoolMappingsOut)
{
    ...
    maxIndex = wistd::max(maxIndex, pWantEnvironment->GetQualifierNames()->GetPoolIndex());
    maxIndex = wistd::max(maxIndex, pWantEnvironment->GetItemTypeNames()->GetPoolIndex());
    maxIndex = wistd::max(maxIndex, pWantEnvironment->GetResourceValueTypeNames()->GetPoolIndex());
    maxIndex = wistd::max(maxIndex, pWantEnvironment->GetResourceValueLocatorNames()->GetPoolIndex());
    maxIndex = wistd::max(maxIndex, pWantEnvironment->GetConditionOperatorNames()->GetPoolIndex());
    ...
    _Inout_ RemapInfo* pPoolMappingsOut)
{
    ...
    maxIndex = wistd::max(maxIndex, pWantRef->GetQualifiersPoolIndex());
    maxIndex = wistd::max(maxIndex, pWantRef->GetItemTypesPoolIndex());
    maxIndex = wistd::max(maxIndex, pWantRef->GetResourceValueTypesPoolIndex());
    maxIndex = wistd::max(maxIndex, pWantRef->GetResourceValueLocatorsPoolIndex());
    maxIndex = wistd::max(maxIndex, pWantRef->GetConditionOperatorsPoolIndex());
