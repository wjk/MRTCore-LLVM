...
DefChecksum::ComputeFileChecksum(_In_ Checksum partialChecksum, _In_ PCWSTR fileToAdd, _Out_ DefChecksum::Checksum* checksum)
{
    *checksum = partialChecksum;
    ...
    if (0 == fileLength.HighPart)
    {
        ...
        DWORD bytesToCopy = wistd::min(remainingBytesInFile, (DWORD)FILE_CHECKSUM_CHUNK_SIZE);
        ...
        while (bytesToCopy > 0)
        {
            ...
            bytesToCopy = wistd::min(remainingBytesInFile, (DWORD)FILE_CHECKSUM_CHUNK_SIZE);
        }
    }
